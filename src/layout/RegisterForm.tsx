...
function Register() {
  ...
  const handleRegister = async () => {
    ...
    */
    try {
      const register = await apiClient.post('/signup', data);
      NotificationSuccess(
        'Te registraste con éxito. Por favor vuelve a ingresar tus datos para entrar.'
      );
      router.push('/');
    } catch (error) {
      NotificationFailure('Hubo un error en la información de registro.');
    }
  };
